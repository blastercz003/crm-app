...
function SidebarSkeleton({ error, onRetry }: { error?: string | null; onRetry?: () => void }) {
  ...
  const loadingBadge = <span className="inline-flex h-8 w-[104px] items-center justify-center gap-1.5 rounded-xl border border-sky-400/30 bg-sky-500/10 px-2 text-[8px] font-bold uppercase leading-none tracking-[0.065em] text-[var(--accent)]"><LoaderCircle aria-hidden size={11} className="animate-spin" /> Načítám</span>
