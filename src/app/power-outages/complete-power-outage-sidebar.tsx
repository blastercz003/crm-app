...
import { CircleAlert, DatabaseZap, Info, MapPinned, SearchCheck } from 'lucide-react'
...
function coverageLabel(status: CompletePowerOutageWorkspace['sources'][number]['coverageStatus']) {
  return ({ idle: 'ČEKÁ', processing: 'ZPRACOVÁNÍ', complete: 'AKTUÁLNÍ', partial: 'ČÁSTEČNÉ', error: 'CHYBA' } as const)[status]
}
