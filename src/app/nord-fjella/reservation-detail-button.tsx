...
function ReservationDetailModal({
  ...
  const modalContent = (
    ...
    >
      ...
      >
        <div className="clients-modal__shell relative flex h-[calc(100dvh-1rem)] min-h-0 w-full max-w-5xl flex-col overflow-hidden rounded-3xl sm:h-auto sm:max-h-[calc(100dvh-2rem)]">
              ...
              <div className="grid gap-5">
                ...
                {recordType === 'reservation' ? (
                  <>
                    ...
                    <div className="nord-fjella-modal-subtle-card p-4">
                      <div className="mb-4 text-sm font-semibold text-gray-900">Kauce</div>
                      <div className="grid gap-4 md:grid-cols-4">
