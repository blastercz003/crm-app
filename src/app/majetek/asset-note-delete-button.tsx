...
import { deleteAssetNoteAction, type DeleteAssetNoteActionState } from './actions'

const initialState: DeleteAssetNoteActionState = {
  success: false,
  error: null,
}

type AssetNoteDeleteButtonProps = {
  assetId: string
  noteId: string
}

export function AssetNoteDeleteButton({ assetId, noteId }: AssetNoteDeleteButtonProps) {
  const router = useRouter()
  const [isConfirming, setIsConfirming] = useState(false)
  const [state, formAction] = useActionState(deleteAssetNoteAction, initialState)
