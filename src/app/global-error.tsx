...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  ...
  useEffect(() => {
    ...
    async function report() {
      try {
        const reportPayload = {
          errorType: error.name || 'UnhandledGlobalError',
  ...
  return (
    <html lang="cs" data-theme="light">
      <body className="min-h-screen bg-[linear-gradient(160deg,#f8fafc_0%,#eef3f8_50%,#e9f0f7_100%)] px-4 py-8 text-gray-900">
        <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-3xl items-center">
          <section className="w-full rounded-[28px] border border-white/75 bg-[linear-gradient(155deg,rgba(255,255,255,0.96)_0%,rgba(248,250,252,0.92)_48%,rgba(241,245,249,0.88)_100%)] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_20px_44px_rgba(15,23,42,0.12)] backdrop-blur-[10px] sm:p-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-6 text-gray-600 sm:text-base">
                  Tohle je poslední záchranná obrazovka. Pošli nám níže uvedený
                  kód a dohledáme přesný stack trace i místo pádu.
                </p>
              </div>
              ...
              <div className="grid gap-3 rounded-2xl border border-zinc-200/80 bg-white/80 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.92)]">
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm text-gray-900">
                    {error.name || 'UnhandledGlobalError'}
                  </div>
                </div>
