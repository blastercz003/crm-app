            ...
            <div className="jobs-page__table-shell">
              ...
              {totalPages > 1 ? (
                <nav
                  ...
                  className="app-pagination print-hidden mt-4 flex justify-center"
                >
                  <div className="app-pagination__panel flex items-center gap-1 rounded-2xl border border-white/75 bg-[linear-gradient(155deg,rgba(255,255,255,0.94)_0%,rgba(241,246,251,0.88)_100%)] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.92),0_10px_22px_rgba(15,23,42,0.1)]">
                    <Link
                      ...
                      className={`app-pagination__link inline-flex h-9 min-w-9 items-center justify-center rounded-xl px-2 text-sm font-semibold transition ${
                        currentPage === 1
