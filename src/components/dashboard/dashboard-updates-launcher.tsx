...
export function DashboardUpdatesLauncher({
  ...
  const buttonClassName =
    variant === 'mobile'
      ? 'relative inline-flex min-h-[44px] w-full items-center justify-center overflow-visible rounded-2xl border border-[#2b6f9f]/95 bg-[linear-gradient(160deg,rgba(60,132,186,0.95)_0%,rgba(41,117,174,0.96)_45%,rgba(26,92,146,0.98)_100%)] px-5 text-sm font-semibold uppercase tracking-[0.08em] text-white shadow-[inset_0_1px_0_rgba(170,217,247,0.35),0_9px_20px_rgba(9,48,82,0.26)] backdrop-blur-xl transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#1f5f8e] hover:shadow-[inset_0_1px_0_rgba(170,217,247,0.35),0_12px_24px_rgba(9,48,82,0.34)] active:scale-[0.98]'
      : 'relative inline-flex min-h-full self-stretch items-center justify-center overflow-visible rounded-2xl border border-[#2b6f9f]/95 bg-[linear-gradient(160deg,rgba(60,132,186,0.95)_0%,rgba(41,117,174,0.96)_45%,rgba(26,92,146,0.98)_100%)] px-5 text-sm font-semibold uppercase tracking-[0.08em] text-white shadow-[inset_0_1px_0_rgba(170,217,247,0.35),0_8px_18px_rgba(9,48,82,0.24)] backdrop-blur-xl transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#1f5f8e] hover:shadow-[inset_0_1px_0_rgba(170,217,247,0.35),0_12px_24px_rgba(9,48,82,0.34)]'
